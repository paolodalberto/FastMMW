...
void s_saddmulRB(float *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float *datac, 
 float *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float *dataa, 
 float *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float *datab) {
 	S_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	S_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	S_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(s_saddmulR(C,A,B));
 }

void s_smulRB(float *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float *datac, 
 float *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float *dataa, 
 float *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float *datab) {
 	S_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	S_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	S_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(s_smulR(C,A,B));
 }
...
void s_wmRB(float *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float *datac, 
 float *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float *dataa, 
 float *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float *datab) {
 	S_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	S_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	S_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(s_wmR(C,A,B));
 }

void s_wmaddRB(float *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float *datac, 
 float *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float *dataa, 
 float *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float *datab) {
 	S_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	S_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	S_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(s_wmaddR(C,A,B));
 }

void s_wmTRB(float *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float *datac, 
 float *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float *dataa, 
 float *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float *datab) {
 	S_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	S_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	S_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(s_wmTR(C,A,B));
 }

void s_wmaddTRB(float *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float *datac, 
 float *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float *dataa, 
 float *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float *datab) {
 	S_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	S_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	S_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(s_wmaddTR(C,A,B));
 }
...
void s_BMADDRB(float *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float *datac, 
 float *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float *dataa, 
 float *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float *datab) {
 	S_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	S_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	S_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(s_BMADDR(C,A,B));
 }
...
void s_BMOWRRB(float *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float *datac, 
 float *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float *dataa, 
 float *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float *datab) {
 	S_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	S_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	S_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(s_BMOWRR(C,A,B));
 }
...
void d_saddmulRB(double *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double *datac, 
 double *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double *dataa, 
 double *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double *datab) {
 	D_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	D_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	D_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(d_saddmulR(C,A,B));
 }

void d_smulRB(double *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double *datac, 
 double *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double *dataa, 
 double *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double *datab) {
 	D_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	D_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	D_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(d_smulR(C,A,B));
 }
...
void d_wmRB(double *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double *datac, 
 double *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double *dataa, 
 double *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double *datab) {
 	D_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	D_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	D_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(d_wmR(C,A,B));
 }

void d_wmaddRB(double *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double *datac, 
 double *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double *dataa, 
 double *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double *datab) {
 	D_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	D_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	D_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(d_wmaddR(C,A,B));
 }

void d_wmTRB(double *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double *datac, 
 double *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double *dataa, 
 double *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double *datab) {
 	D_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	D_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	D_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(d_wmTR(C,A,B));
 }

void d_wmaddTRB(double *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double *datac, 
 double *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double *dataa, 
 double *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double *datab) {
 	D_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	D_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	D_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(d_wmaddTR(C,A,B));
 }
...
void d_BMADDRB(double *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double *datac, 
 double *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double *dataa, 
 double *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double *datab) {
 	D_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	D_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	D_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(d_BMADDR(C,A,B));
 }
...
void d_BMOWRRB(double *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double *datac, 
 double *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double *dataa, 
 double *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double *datab) {
 	D_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	D_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	D_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(d_BMOWRR(C,A,B));
 }
...
void c_saddmulRB(float complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float complex *datac, 
 float complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float complex *dataa, 
 float complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float complex *datab) {
 	C_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	C_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	C_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(c_saddmulR(C,A,B));
 }

void c_smulRB(float complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float complex *datac, 
 float complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float complex *dataa, 
 float complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float complex *datab) {
 	C_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	C_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	C_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(c_smulR(C,A,B));
 }
...
void c_wmRB(float complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float complex *datac, 
 float complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float complex *dataa, 
 float complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float complex *datab) {
 	C_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	C_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	C_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(c_wmR(C,A,B));
 }

void c_wmaddRB(float complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float complex *datac, 
 float complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float complex *dataa, 
 float complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float complex *datab) {
 	C_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	C_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	C_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(c_wmaddR(C,A,B));
 }

void c_wmTRB(float complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float complex *datac, 
 float complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float complex *dataa, 
 float complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float complex *datab) {
 	C_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	C_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	C_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(c_wmTR(C,A,B));
 }

void c_wmaddTRB(float complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float complex *datac, 
 float complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float complex *dataa, 
 float complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float complex *datab) {
 	C_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	C_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	C_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(c_wmaddTR(C,A,B));
 }
...
void c_BMADDRB(float complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float complex *datac, 
 float complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float complex *dataa, 
 float complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float complex *datab) {
 	C_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	C_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	C_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(c_BMADDR(C,A,B));
 }
...
void c_BMOWRRB(float complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, float complex *datac, 
 float complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, float complex *dataa, 
 float complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, float complex *datab) {
 	C_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	C_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	C_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(c_BMOWRR(C,A,B));
 }
...
void z_saddmulRB(double complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double complex *datac, 
 double complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double complex *dataa, 
 double complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double complex *datab) {
 	Z_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	Z_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	Z_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(z_saddmulR(C,A,B));
 }

void z_smulRB(double complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double complex *datac, 
 double complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double complex *dataa, 
 double complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double complex *datab) {
 	Z_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	Z_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	Z_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(z_smulR(C,A,B));
 }
...
void z_wmRB(double complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double complex *datac, 
 double complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double complex *dataa, 
 double complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double complex *datab) {
 	Z_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	Z_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	Z_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(z_wmR(C,A,B));
 }

void z_wmaddRB(double complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double complex *datac, 
 double complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double complex *dataa, 
 double complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double complex *datab) {
 	Z_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	Z_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	Z_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(z_wmaddR(C,A,B));
 }

void z_wmTRB(double complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double complex *datac, 
 double complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double complex *dataa, 
 double complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double complex *datab) {
 	Z_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	Z_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	Z_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(z_wmTR(C,A,B));
 }

void z_wmaddTRB(double complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double complex *datac, 
 double complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double complex *dataa, 
 double complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double complex *datab) {
 	Z_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	Z_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	Z_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(z_wmaddTR(C,A,B));
 }
...
void z_BMADDRB(double complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double complex *datac, 
 double complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double complex *dataa, 
 double complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double complex *datab) {
 	Z_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	Z_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	Z_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(z_BMADDR(C,A,B));
 }
...
void z_BMOWRRB(double complex *betac, int *transc, int *mc, int *nc, int *Mc, int *Nc, double complex *datac, 
 double complex *betaa, int *transa, int *ma, int *na, int *Ma, int *Na, double complex *dataa, 
 double complex *betab, int *transb, int *mb, int *nb, int *Mb, int *Nb, double complex *datab) {
 	Z_Matrix C = {  datac, *mc, *nc, *Mc, *Nc, flags[*transc], *betac}; 
 	Z_Matrix A = {  dataa, *ma, *na, *Ma, *Na, flags[*transa], *betaa};  
 	Z_Matrix B = {  datab, *mb, *nb, *Mb, *Nb, flags[*transb], *betab};
 	TEXECUTE(z_BMOWRR(C,A,B));
 }
