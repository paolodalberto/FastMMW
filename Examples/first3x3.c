...
#define GEMM gpuGEMMS
#define ADD s_add
#define SUB s_sub
S_TAddOperands computation[MAXOPS];
#elif DOUBLE_PRECISION
#define GEMM gpuGEMMD
#define ADD d_add
#define SUB d_sub
D_TAddOperands computation[MAXOPS];
#elif SINGLE_COMPLEX
#define GEMM gpuGEMMC
#define ADD c_add
#define SUB c_sub
C_TAddOperands computation[MAXOPS];
#elif DOUBLE_COMPLEX
#define GEMM gpuGEMMZ
#define ADD z_add
#define SUB z_sub
Z_TAddOperands computation[MAXOPS];
#endif
MatrixComputation m[MAXOPS];
