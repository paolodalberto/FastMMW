...
static inline Matrix Q0(Matrix x) {
  Matrix x0 = { M0(x.data,x.m,x.n,x.M,x.N), S0(x.m,x.n), x.M, x.N, x.trans, x.beta, x.gpu};
  return x0;
}
static inline Matrix Q1(Matrix x) {

  if (x.trans=='c' || x.trans =='t') { 
    Matrix x0 = { M2(x.data,x.m,x.n,x.M,x.N), S2(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
    return x0;
  }
  else {
    Matrix x0 = { M1(x.data,x.m,x.n,x.M,x.N), S1(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
    return x0;
  }
}
...
static inline Matrix Q3(Matrix x) {
  Matrix x0 = { M3(x.data,x.m,x.n,x.M,x.N), S3(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
  return x0;
}
...
static inline Matrix R0(Matrix x) {
  Matrix x0 = { MR0(x.data,x.m,x.n,x.M,x.N), SR0(x.m,x.n), x.M, x.N, x.trans, x.beta, x.gpu};
  return x0;
}
static inline Matrix R1(Matrix x) {

  if (x.trans=='c' || x.trans =='t') { 
    Matrix x0 = { MR2(x.data,x.m,x.n,x.M,x.N), SR2(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
    return x0;
  }
  else {
    Matrix x0 = { MR1(x.data,x.m,x.n,x.M,x.N), SR1(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
    return x0;
  }
}
...
static inline Matrix R3(Matrix x) {
  Matrix x0 = { MR3(x.data,x.m,x.n,x.M,x.N), SR3(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
  return x0;
}


static inline Matrix T0(Matrix x) {
  Matrix x0 = { MT0(x.data,x.m,x.n,x.M,x.N), ST0(x.m,x.n), x.M, x.N, x.trans, x.beta, x.gpu};
  return x0;
}
static inline Matrix T1(Matrix x) {

  if (x.trans=='c' || x.trans =='t') { 
    Matrix x0 = { MT2(x.data,x.m,x.n,x.M,x.N), ST2(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
    return x0;
  }
  else {
    Matrix x0 = { MT1(x.data,x.m,x.n,x.M,x.N), ST1(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
    return x0;
  }
}
...
static inline Matrix T3(Matrix x) {
  Matrix x0 = { MT3(x.data,x.m,x.n,x.M,x.N), ST3(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
  return x0;
}
...
static inline Matrix W0(Matrix x) {
  Matrix x0 = { MV0(x.data,x.m,x.n,x.M,x.N), SV0(x.m,x.n), x.M, x.N, x.trans, x.beta, x.gpu};
  return x0;
}
static inline Matrix W1(Matrix x) {

  if (x.trans=='c' || x.trans =='t') { 
    Matrix x0 = { MV2(x.data,x.m,x.n,x.M,x.N), SV2(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
    return x0;
  }
  else {
    Matrix x0 = { MV1(x.data,x.m,x.n,x.M,x.N), SV1(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
    return x0;
  }
}
...
static inline Matrix W3(Matrix x) {
  Matrix x0 = { MV3(x.data,x.m,x.n,x.M,x.N), SV3(x.m,x.n), x.M, x.N, x.trans,x.beta, x.gpu};
  return x0;
}
...
static inline Matrix Q1K(Matrix x, int k) {
  ...
  if (x.trans=='c' || x.trans =='t') { 
    Matrix x0 = { M2K(x.data,x.m,x.n,x.M,x.N,k), S2K(x.m,x.n,k), x.M, x.N, x.trans,x.beta, x.gpu};
    return x0;
  }
  else {
    Matrix x0 = { M1K(x.data,x.m,x.n,x.M,x.N,k), S1K(x.m,x.n,k), x.M, x.N, x.trans,x.beta, x.gpu};
    return x0;
  }
}
...
static inline Matrix RQ0(Matrix x, Matrix ref) {
  Matrix x0 = { x.data, S0(ref.m,ref.n), x.M, x.N, ref.trans,x.beta, x.gpu};
  return x0;
}
static inline Matrix RQ1(Matrix x, Matrix ref) {
  if (ref.trans=='c' || ref.trans =='t') { 
    Matrix x0 = { x.data, S2(ref.m,ref.n), x.M, x.N, ref.trans,x.beta, x.gpu};   
    return x0;
  }
  else {
    Matrix x0 = { x.data, S1(ref.m,ref.n), x.M, x.N, ref.trans,x.beta, x.gpu};
    return x0;
  }
}
...
static inline Matrix RQ3(Matrix x, Matrix ref) {
  Matrix x0 = { x.data, S3(ref.m,ref.n), x.M, x.N, ref.trans,x.beta, x.gpu};
  return x0;
}
