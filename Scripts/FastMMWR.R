...
s_BMADD_PIPER <- function(a,A,b,B) { 
...
d_BMADD_PIPER <- function(a,A,b,B) { 
...
c_BMADD_PIPER <- function(a,A,b,B) { 
...
z_BMADD_PIPER <- function(a,A,b,B) { 
...
s_mm_leaf_computation_maddR <- function(a,A,b,B) { 
...
d_mm_leaf_computation_maddR <- function(a,A,b,B) { 
...
c_mm_leaf_computation_maddR <- function(a,A,b,B) { 
...
z_mm_leaf_computation_maddR <- function(a,A,b,B) { 
