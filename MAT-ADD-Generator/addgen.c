...
int main(int argc, char **argv) { 
  ...
  printf("void add (DEF(c), DEF(a), DEF(b));				        \n");
  printf("void sub (DEF(c), DEF(a), DEF(b));				        \n");
  printf("void add_amd (DEF(c), DEF(a), DEF(b));				        \n");
  printf("void sub_amd (DEF(c), DEF(a), DEF(b));				        \n");
  printf("void add_t (DEF(c), DEF(a), DEF(b));				        \n");
  printf("void sub_t (DEF(c), DEF(a), DEF(b));				        \n");
  printf("void add_amd_t (DEF(c), DEF(a), DEF(b));			        \n");
  printf("void sub_amd_t (DEF(c), DEF(a), DEF(b));			        \n");
  printf("void copy(DEF(c), DEF(a));					        \n");
  printf("void copy_matrix(DEF(c), DEF(a),DEF(b));			        \n");
  printf("int  comp(DEF(c), DEF(a));					        \n");
  printf("void print(DEF(c));						        \n");
  printf("void ptadd(DEF(c), DEF(a), DEF(b));				        \n");
  printf("void ptadd_t(DEF(c), DEF(a), DEF(b));				        \n");
  printf("void ptsub(DEF(c), DEF(a), DEF(b));				        \n");
  printf("void ptsub_t(DEF(c), DEF(a), DEF(b));				        \n");
  ...
  printf("								        \n");
  printf("void s_add (S_Matrix c, S_Matrix a, S_Matrix b);				        \n");
  printf("void s_sub (S_Matrix c, S_Matrix a, S_Matrix b);				        \n");
  printf("void s_add_amd (S_Matrix c, S_Matrix a, S_Matrix b);			        \n");
  printf("void s_sub_amd (S_Matrix c, S_Matrix a, S_Matrix b);			        \n");
  printf("void s_add_t (S_Matrix c, S_Matrix a, S_Matrix b);				        \n");
  printf("void s_sub_t (S_Matrix c, S_Matrix a, S_Matrix b);				        \n");
  printf("void s_add_amd_t (S_Matrix c, S_Matrix a, S_Matrix b);			        \n");
  printf("void s_sub_amd_t (S_Matrix c, S_Matrix a, S_Matrix b);			        \n");
  printf("void s_copy(S_Matrix c, S_Matrix a);					        \n");
  printf("void s_copy_matrix(S_Matrix c, S_Matrix a, S_Matrix b);			        \n");
  printf("int  s_comp(S_Matrix c, S_Matrix a);					        \n");
  printf("void s_print(S_Matrix c);						        \n");
  printf("void s_ptadd(S_Matrix c, S_Matrix a, S_Matrix b);				        \n");
  printf("void s_ptadd_t(S_Matrix c, S_Matrix a, S_Matrix b);				        \n");
  printf("void s_ptsub(S_Matrix c, S_Matrix a, S_Matrix b);				        \n");
  printf("void s_ptsub_t(S_Matrix c, S_Matrix a, S_Matrix b);				        \n");
  printf("void s_ptcopy(S_Matrix c, S_Matrix a, S_Matrix b);				        \n");
  ...
  printf("								        \n");
  printf("void d_add (D_Matrix c, D_Matrix a, D_Matrix b);				        \n");
  printf("void d_sub (D_Matrix c, D_Matrix a, D_Matrix b);				        \n");
  printf("void d_add_amd (D_Matrix c, D_Matrix a, D_Matrix b);			        \n");
  printf("void d_sub_amd (D_Matrix c, D_Matrix a, D_Matrix b);			        \n");
  printf("void d_add_t (D_Matrix c, D_Matrix a, D_Matrix b);				        \n");
  printf("void d_sub_t (D_Matrix c, D_Matrix a, D_Matrix b);				        \n");
  printf("void d_add_amd_t (D_Matrix c, D_Matrix a, D_Matrix b);			        \n");
  printf("void d_sub_amd_t (D_Matrix c, D_Matrix a, D_Matrix b);			        \n");
  printf("void d_copy(D_Matrix c, D_Matrix a);					        \n");
  printf("void d_copy_matrix(D_Matrix c, D_Matrix a, D_Matrix b);			        \n");
  printf("int  d_comp(D_Matrix c, D_Matrix a);					        \n");
  printf("void d_print(D_Matrix c);						        \n");
  printf("void d_ptadd(D_Matrix c, D_Matrix a, D_Matrix b);				        \n");
  printf("void d_ptadd_t(D_Matrix c, D_Matrix a, D_Matrix b);				        \n");
  printf("void d_ptsub(D_Matrix c, D_Matrix a, D_Matrix b);				        \n");
  printf("void d_ptsub_t(D_Matrix c, D_Matrix a, D_Matrix b);				        \n");
  printf("void d_ptcopy(D_Matrix c, D_Matrix a, D_Matrix b);				        \n");
  ...
  printf("								        \n");
  printf("void c_add (C_Matrix c, C_Matrix a, C_Matrix b);				        \n");
  printf("void c_sub (C_Matrix c, C_Matrix a, C_Matrix b);				        \n");
  printf("void c_add_amd (C_Matrix c, C_Matrix a, C_Matrix b);			        \n");
  printf("void c_sub_amd (C_Matrix c, C_Matrix a, C_Matrix b);			        \n");
  printf("void c_add_t (C_Matrix c, C_Matrix a, C_Matrix b);				        \n");
  printf("void c_sub_t (C_Matrix c, C_Matrix a, C_Matrix b);				        \n");
  printf("void c_add_amd_t (C_Matrix c, C_Matrix a, C_Matrix b);			        \n");
  printf("void c_sub_amd_t (C_Matrix c, C_Matrix a, C_Matrix b);			        \n");
  printf("void c_copy(C_Matrix c, C_Matrix a);					        \n");
  printf("void c_copy_matrix(C_Matrix c, C_Matrix a, C_Matrix b);			        \n");
  printf("int  c_comp(C_Matrix c, C_Matrix a);					        \n");
  printf("void c_print(C_Matrix c);						        \n");
  printf("void c_ptadd(C_Matrix c, C_Matrix a, C_Matrix b);				        \n");
  printf("void c_ptadd_t(C_Matrix c, C_Matrix a, C_Matrix b);				        \n");
  printf("void c_ptsub(C_Matrix c, C_Matrix a, C_Matrix b);				        \n");
  printf("void c_ptsub_t(C_Matrix c, C_Matrix a, C_Matrix b);				        \n");
  printf("void c_ptcopy(C_Matrix c, C_Matrix a, C_Matrix b);				        \n");
  ...
  printf("								        \n");
  printf("void z_add (Z_Matrix c, Z_Matrix a, Z_Matrix b);				        \n");
  printf("void z_sub (Z_Matrix c, Z_Matrix a, Z_Matrix b);				        \n");
  printf("void z_add_amd (Z_Matrix c, Z_Matrix a, Z_Matrix b);			        \n");
  printf("void z_sub_amd (Z_Matrix c, Z_Matrix a, Z_Matrix b);			        \n");
  printf("void z_add_t (Z_Matrix c, Z_Matrix a, Z_Matrix b);				        \n");
  printf("void z_sub_t (Z_Matrix c, Z_Matrix a, Z_Matrix b);				        \n");
  printf("void z_add_amd_t (Z_Matrix c, Z_Matrix a, Z_Matrix b);			        \n");
  printf("void z_sub_amd_t (Z_Matrix c, Z_Matrix a, Z_Matrix b);			        \n");
  printf("void z_copy(Z_Matrix c, Z_Matrix a);					        \n");
  printf("void z_copy_matrix(Z_Matrix c, Z_Matrix a, Z_Matrix b);			        \n");
  printf("int  z_comp(Z_Matrix c, Z_Matrix a);					        \n");
  printf("void z_print(Z_Matrix c);						        \n");
  printf("void z_ptadd(Z_Matrix c, Z_Matrix a, Z_Matrix b);				        \n");
  printf("void z_ptadd_t(Z_Matrix c, Z_Matrix a, Z_Matrix b);				        \n");
  printf("void z_ptsub(Z_Matrix c, Z_Matrix a, Z_Matrix b);				        \n");
  printf("void z_ptsub_t(Z_Matrix c, Z_Matrix a, Z_Matrix b);				        \n");
  printf("void z_ptcopy(Z_Matrix c, Z_Matrix a, Z_Matrix b);				        \n");
